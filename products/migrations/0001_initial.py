# Generated by Django 3.2 on 2024-08-27 15:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.TextField(max_length=10000, verbose_name='Desccription')),
                ('price', models.FloatField(verbose_name='Price')),
                ('flag', models.CharField(choices=[('New', 'New'), ('Feature', 'Feature'), ('Sale', 'Sale')], max_length=10, verbose_name='Flag')),
                ('quantitity', models.IntegerField(verbose_name='Quantitity')),
